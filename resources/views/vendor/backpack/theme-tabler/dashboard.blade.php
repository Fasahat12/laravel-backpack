    ...
    Widget::add()
        ...
        ->content([
            ...
            Widget::make()
                ...
                ->value(149)
                ->description('Registered users.')
                ->progress(100*(int)149 / 1000)
                ->hint(1000 - 149 . ' more until next milestone.'),
            Widget::make()
                ->type('progress')
                ->class('card mb-3')
                ->statusBorder('start')
                ...
                ->value(139)
                ->description('Registered users.')
                ->progress(100*(int)139 / 1000)
                ->hint(1000 - 139 . ' more until next milestone.'),
            Widget::make()
                ->type('progress')
                ->class('card mb-3')
                ->statusBorder('start')
                ...
                ->value(200)
                ->description('Registered users.')
                ->progress(100*(int)200 / 1000)
                ->hint(1000 - 200 . ' more until next milestone.')
        ]);
@endphp
